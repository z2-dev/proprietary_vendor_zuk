...
LOCAL_SRC_FILES := proprietary/system/lib64/libloc_api_v02.so
LOCAL_MULTILIB := 64
...
LOCAL_MODULE_OWNER := zuk
LOCAL_SRC_FILES_64 := proprietary/system/vendor/lib64/libtime_genoff.so
LOCAL_SRC_FILES_32 := proprietary/system/vendor/lib/libtime_genoff.so
LOCAL_MULTILIB := both
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_SUFFIX := .so
...
LOCAL_MODULE_OWNER := zuk
LOCAL_SRC_FILES := proprietary/system/vendor/app/colorservice/colorservice.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
...
LOCAL_MODULE_OWNER := zuk
LOCAL_SRC_FILES := proprietary/system/vendor/app/imssettings/imssettings.apk
LOCAL_CERTIFICATE := platform
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_CLASS := APPS
LOCAL_DEX_PREOPT := false
